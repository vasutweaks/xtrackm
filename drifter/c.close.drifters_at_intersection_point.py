...
df_all = pd.read_csv(f"tracks_intersections_S3A_1.csv")
    ...
    for chunk in chunks:
        ...
        for fd in sorted(
            ...
            if is_within_region_any(
                ...
                df_close["sat"] = sat1
                df_close["drifter_id"] = drifter_id
                df_close["chunk"] = chunk
                df_close["drift_tsta_o"] = drift_tsta_o
                df_close["drift_tend_o"] = drift_tend_o
                df_close["overlap_tsta_o"] = overlap_tsta_o
                df_close["overlap_tend_o"] = overlap_tend_o
                df_close["lon1"] = lon1
                df_close["lat1"] = lat1
                ...
                plt.close()
                found = True
    close_column.append(close_ones)
                # break
