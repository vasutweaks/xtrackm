...
chunk_time_dict = {
    "1_5000": (
        numpy.datetime64("1985-10-30T00:00:00.000000000"),
        numpy.datetime64("1999-11-01T00:00:00.000000000"),
    ),
    "5001_10000": (
        numpy.datetime64("1997-03-20T00:00:00.000000000"),
        numpy.datetime64("2006-09-16T00:00:00.000000000"),
    ),
    "10001_15000": (
        numpy.datetime64("2006-05-24T00:00:00.000000000"),
        numpy.datetime64("2011-01-04T00:00:00.000000000"),
    ),
    "15001_current": (
        numpy.datetime64("2010-10-30T00:00:00.000000000"),
...
for chunk in chunks:
    ...
    for sat in sats_new:
        ...
        if overlap_tsta_o is None or overlap_tend_o is None:
            continue
        print(
            f"{chunk} overlap for {sat} is {overlap_tsta_o} to {overlap_tend_o}"
        )
