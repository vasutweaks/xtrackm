...
long_part = "correlations between oscar zonal current and track zonal current"
...
df = pd.read_csv(f"tracks_corrs_rmses_biass_{sat}_u.csv")
...
plt.savefig(f"tracks_corrs_rmses_biass_{sat}_u.png")
plt.show()
