...
for idx, row in df_all.iterrows():
    ...
    plt.savefig(
        f"track_guvVSoscar_at_intersection_points/guv_timeseries_{sat1}_{track_number_self}_{track_number_other}_{radar_str}.png",
    )
    # plt.show()
    plt.close("all")
